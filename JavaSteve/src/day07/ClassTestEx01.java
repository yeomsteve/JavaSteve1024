...
public class ClassTestEx01 {
	...
	public static void main(String[] args) {
		...
		//캡슐화를 통해 pNo의 접근제한자를 private으로 설정하면 직접접근이 불가능하다.=> 에러발생
		//캡슐화된 pNo에 접근하려면 getter와 setter를 통해 접근해야함.
		//person1.pNo = "000101-3123456";
		
		person1.setpNo = ("000101-3123456");//멤버변수접근법
 ...
 * - public : 본인 클래스 + 같은 패키지 + 자식클래스 + 외부클래스=>전부
 * */
class Person{
