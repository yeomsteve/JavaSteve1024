...
public class StringEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * StringBuffer는 쓰레드에서 safe기능을 제공하고, StringBuilder는 제공안함.
		 * */
		String str = "abc";
		...
		/* indexOf(문자또는 문자열) : 해당 문자열or문자를 0번지부터 탐색하여
		 * 첫번째로 만나는 문자열 or 문자의 시작 번지, 없는경우 -1
		 * lastIndexOf(문자 or 문자열: 해당 문자열or문자를 마지막 번지부터 탐색하여
		 * 첫번째로 만나는 문자열or문자의 시작 번지, 없는경우 -1
		 * contains(문자열 또는 문자) : 해당 문자열or문자가 있는지 없는지를 알려줌
		 * */
		 ...
		 *subString(시작번지, 마지막번지) : 문자열의 시작번지부터 마지막번지 -1 까지 부분문자열 추출
		 * 
		 * 
		 * */
		System.out.println("0번지부터 부분문자열 : " + str.substring(0));
		System.out.println("2번지부터 부분문자열 : " + str.substring(2,3));
		
		/* equals(문자열) : 문자열과 같은지 다른지를 알려줌
		 * 문자열은 참조변수이기 때문에 ==를 통해서는 정확히 같은지 다른지를 비교할수없다. 
		...
		System.out.println("str1과 str2가 같다?(equals) : " + (str1.equals(str3)));
		...
		/* trim() : 시작문자 앞에있는 공백을 제거하고 마지막문자 뒤에있는 공백을 제거*/
		String str5 = "\n\n     \t안녕 하세요.\n\n";
