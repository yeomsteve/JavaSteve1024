...
CREATE TABLE `board` (
  ...
  PRIMARY KEY (`bo_num`),
  KEY `fk_bo_me_id` (`bo_me_id`),
  KEY `fk_bo_bc_num` (`bo_bc_num`),
...
INSERT INTO `board` VALUES (1,'공지사항입니다','오늘은 12일입니다','2022-12-12 16:20:36',1,'qwe',1),(2,'공지사항입니다','오늘은 12일입니다','2022-12-12 16:20:38',1,'qwe',1),(3,'공지사항입니다','오늘은 12일입니다','2022-12-12 16:32:19',1,'qwe',1);
