-- 영화 아바타-물의길 상영시간을 조회하는 쿼리 작성
-- 정렬은 영화관순으로
use cgv;

select ss_date as 상영일, ss_time as 상영시간, ci_name as 상영관, ss_possible_seat as 예매가능좌석수 from screen_schedule
...
-- 강남CGV 1관에서 18일 9:50에 상영하는 아바타의 예매가능 좌석들을 조회
...
case
 ...
 from screen_schedule
    ...
    -- 아바타를 상영하는 극장 조회
select th_name as 지점 from screen_schedule
